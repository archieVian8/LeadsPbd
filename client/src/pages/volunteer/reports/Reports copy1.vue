    ...
    <q-page padding>
      <div class="card-container column items-center">
        <q-card v-for="evac in evacs" :key="index" class="shadow-7">
          ...
          <q-separator size="0.125rem" />
          <q-card-section>
            <q-btn color="primary" label="Bantu Obat" @click="onDetailObat()"></q-btn>
            <q-btn color="primary" label="Bantu Pangan" @click="onDetailPangan()"></q-btn>
            <q-btn color="primary" label="Bantu Sandang" @click="onDetailSandang()"></q-btn>
          </q-card-section>
