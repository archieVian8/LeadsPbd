<template>
    ...
    <template v-slot:top="props">
        ...
        <div v-if="$q.screen.gt.xs" class="col">
          <q-toggle v-model="visibleMedicineColumns" val="namaObat" label="namaObat" />
          <q-toggle v-model="visibleMedicineColumns" val="kebutuhanAwal" label="kebutuhanAwal" />
          <q-toggle v-model="visibleMedicineColumns" val="terpenuhi" label="terpenuhi" />
          <q-toggle v-model="visibleMedicineColumns" val="sisaKebutuhan" label="sisaKebutuhan" />
        </div>
        <q-select
          v-else
      ...
      <template v-slot:body-cell-actions="props">
        <q-td :props="props">
          <q-btn color="primary" label="Donate" @click="onEditMedicine(props.row)"></q-btn>
        </q-td>
      </template>
    ...
    <template v-slot:top="props">
        ...
        <div v-if="$q.screen.gt.xs" class="col">
          <q-toggle v-model="visibleFoodsColumns" val="namaMakanan" label="namaMakanan" />
          <q-toggle v-model="visibleFoodsColumns" val="kebutuhanAwal" label="kebutuhanAwal" />
          <q-toggle v-model="visibleFoodsColumns" val="terpenuhi" label="terpenuhi" />
          <q-toggle v-model="visibleFoodsColumns" val="sisaKebutuhan" label="sisaKebutuhan" />
        </div>
        <q-select
          v-else
      ...
      <template v-slot:body-cell-actions="props">
        <q-td :props="props">
          <q-btn color="primary" label="Donate" @click="onEditFoods(props.row)"></q-btn>
        </q-td>
      </template>
    ...
    <template v-slot:top="props">
        ...
        <div v-if="$q.screen.gt.xs" class="col">
          <q-toggle v-model="visibleClothingColumns" val="namaPakaian" label="namaPakaian" />
          <q-toggle v-model="visibleClothingColumns" val="kebutuhanAwal" label="kebutuhanAwal" />
          <q-toggle v-model="visibleClothingColumns" val="terpenuhi" label="terpenuhi" />
          <q-toggle v-model="visibleClothingColumns" val="sisaKebutuhan" label="sisaKebutuhan" />
        </div>
        <q-select
          v-else
      ...
      <template v-slot:body-cell-actions="props">
        <q-td :props="props">
          <q-btn color="primary" label="Donate"
...
const medColumnsConst = [
{
  ...
  { name: 'actions', label: 'Donate', required: true },
...
export default {
  ...
  mounted()
  {
      ...
      console.log(this.locId)
      //this.locName = this.$route.query.locName
