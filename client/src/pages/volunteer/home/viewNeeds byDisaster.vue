...
export default {
  ...
  methods: {
    ...
    async getMedicineByDisasterId(){
        console.log('getMedicineByDisasterId - called' )
        ...
        console.log("viewNeeds.vue-getMedicineByDisasterId")
        console.log(payload)

        await api.post('/admin/getMedicineByDisasterId', payload ).then((response)=>{
      ...
      async getFoodsByDisasterId(){
        console.log('getFoodsByDisasterId - called' )
        //this.medRows = []
        const payload = {
          "disasterId" : this.disasterId,
        }
        console.log("viewNeeds.vue-getFoodsByDisasterId")
        console.log(payload)

        await api.post('/admin/getFoodsByDisasterId', payload ).then((response)=>{
          console.log (response)
      ...
      async getClothingByDisasterId(){
        console.log('getClothingByDisasterId - called' )
        //this.medRows = []
        const payload = {
          "disasterId" : this.disasterId,
        }
        console.log("viewNeeds.vue-getClothingByDisasterId")
        console.log(payload)

        await api.post('/admin/getClothingByDisasterId', payload ).then((response)=>{
          console.log (response)
  ...
  mounted()
  {
      ...
      this.getMedicineByDisasterId()
      this.medColumns = medColumnsConst

      this.getFoodsByDisasterId()
      this.foodsColumns = foodsColumnsConst

      this.getClothingByDisasterId()
