...
export default {
  ...
  methods: {
    ...
    onEditMedicine (row) {
      ...
      this.$router.push(`/volunteer/donateEvac?type=Obat&itemId=${row.id}&locId=${this.locId}&evacName=${row.evacName}&itemName=${row.medicineName}&minusQuantity=${row.medicineNameMinusQuantity}`)
    },
    ...
    onEditFoods (row) {
      ...
      this.$router.push(`/volunteer/donateEvac?type=Pangan&itemId=${row.id}&locId=${this.locId}&evacName=${row.evacName}&itemName=${row.foodsName}&minusQuantity=${row.foodsNameMinusQuantity}`)
    },
    ...
    onEditClothing (row) {
      ...
      this.$router.push(`/volunteer/donateEvac?type=Sandang&itemId=${row.id}&locId=${this.locId}&evacName=${row.evacName}&itemName=${row.clothingName}&minusQuantity=${row.clothingNameMinusQuantity}`)
    },
