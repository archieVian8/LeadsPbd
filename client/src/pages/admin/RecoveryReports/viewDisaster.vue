  ...
  <q-layout view="hHr LpR lFf">
    <q-page padding>
      ...
      <div class="card-container row justify-center">
        <q-card v-for="disaster in filteredDisasters" :key="index" class="shadow-7 cursor-pointer col-xs-11 col-sm-11 col-md-3 col-lg-3 col-xl-3" @click="onClickCard(disaster.id)">
...
export default {
  ...
  methods: {
    ...
    onClickCard(disasterId) {
      this.$router.push(`/admin/reports/reportEvac?Uid=${this.Uid}&Uname=${this.Uname}&disasterId=${disasterId}`);
    },
    localize(dateInput) {
